...
function App() {
    ...
    function sendRegistrationData(userInfo: string[]) {
        ...
        if (localStorage.getItem("login") == null) {
            ...
            const newNewNewNewNewNewNewNEWAllowserverdatablat = [...dataAllowServer];
            ...
            tempLogin.login.forEach(el => {
                if (!isDuplicate) {
                    if (userData[1] == el) {
                        newNewNewNewNewNewNewNEWAllowserverdatablat[0] = 1;
                        isDuplicate = true;
                    }
                }
            })
            if (!isDuplicate) {
                ...
                newNewNewNewNewNewNewNEWAllowserverdatablat[0] = 0;
                setPageStatus(1);
                setPage(3);
            }
            setDataAllowServer(newNewNewNewNewNewNewNEWAllowserverdatablat);
        }
    }
